...
export const ROUTE_EXPECTATIONS: Record<string, Expectation> = {
  ...
  "/api/quiz/modules": { auth: ["user"], rateLimit: false, validation: true },
  "/api/quiz/module/[moduleId]": { auth: ["user"], rateLimit: false, validation: true },
  "/api/quiz/module/[moduleId]/submit": { auth: ["user"], rateLimit: false, validation: true },
  "/api/quiz/subjects": { auth: ["user"], rateLimit: false, validation: true },
  "/api/quiz/subject/[subjectId]": { auth: ["user"], rateLimit: false, validation: true },
  "/api/quiz/subject/[subjectId]/submit": { auth: ["user"], rateLimit: false, validation: true },
