  ...
  return (
    <main className="min-h-screen bg-paper flex flex-col px-6 py-12 md:px-16 md:py-20">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-2xl animate-pulse">
        {[1, 2, 3, 4].map((i) => (
          <div key={i} className="border border-ink-faint p-8 flex flex-col gap-4">
            <div className="h-3 w-16 bg-ink-faint/20" />
            <div className="h-8 w-3/4 bg-ink-faint/25" />
            <div className="h-3 w-1/2 bg-ink-faint/20" />
            <div className="h-3 w-1/3 bg-ink-faint/20" />
            <div className="h-3 w-1/4 bg-ink-faint/20 mt-auto" />
          </div>
        ))}
      </div>
